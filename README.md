...
提供芯片级支持，由 ST 官方维护，项目中不直接修改业务逻辑。

#### drivers/（外设驱动层）

GPIO / UART / SPI / I2C / TIM / DMA / CAN 等
...
想看通信/事件机制 → mcu/services/

想看外设与硬件 → mcu/drivers/ + mcu/board/

想理解系统启动 → mcu/core/

想看 RTOS 内核 → crm/FreeRTOS/